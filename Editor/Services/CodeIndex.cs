...
namespace UnityAssistant.Editor.Services
{
    ...
    public static class CodeIndex
    {
        ...
        public static void RebuildIndex()
        {
            ...
            Debug.Log($"UnityAssistant CodeIndex rebuilt. Scripts: {ScriptsByPath.Count}, Edges: {Edges.Count}");
        }
        ...
        public static ScriptFileData[] GetRelevantScriptsUsingIndex(string prompt, string selectedScriptPath, int maxScripts = 8)
        {
            ...
            void AddByPath(string path)
            {
                ...
                ScriptIndexEntry entry = GetScriptByPath(path);
                if (entry == null)
                    return;
                ...
                result[path] = new ScriptFileData
                {
                    path = path,
